    ...
    pois: [
      { 
        ...
        shop: {
          ...
          items: [
            { id: 'si1', itemSlug: 'health-potion-1', price: 50, currency: 'xenocoins', isAvailable: true },
            { id: 'si2', itemSlug: 'magic-apple-1', price: 25, currency: 'xenocoins', isAvailable: true },
            { id: 'si3', itemSlug: 'happiness-toy-1', price: 30, currency: 'xenocoins', isAvailable: true }
          ]
        }
      },
    ...
    pois: [
      ...
      { 
        ...
        shop: {
          ...
          items: [
            { id: 'si4', itemSlug: 'energy-drink-1', price: 75, currency: 'xenocoins', isAvailable: true },
            { id: 'si5', itemSlug: 'desert-crystal-1', price: 200, currency: 'xenocoins', isAvailable: true }
          ]
        }
      },
    ...
    pois: [
      ...
      { 
        ...
        shop: {
          ...
          items: [
            { id: 'si6', itemSlug: 'iron-armor-1', price: 500, currency: 'xenocoins', isAvailable: true },
            { id: 'si7', itemSlug: 'crystal-sword-1', price: 1000, currency: 'xenocoins', isAvailable: true },
            { id: 'si8', itemSlug: 'premium-elixir-1', price: 5, currency: 'cash', isAvailable: true }
          ]
        }
      },
...
export const WorldScreen: React.FC = () => {
  ...
  const { xenocoins, cash, updateCurrency, addToInventory, getUniversalItem } = useGameStore();
  ...
  if (!universalItem) {
    return (
      <div className="p-4 bg-red-50 border border-red-200 rounded-2xl">
        <p className="text-red-700 text-sm">Item not available: {shopItem.itemSlug}</p>
      </div>
    );
  }
